...
class CodeTool {
  ...
  /**
   * Default title for CodeTool's toolbox icon
   *
   * @public
   * @returns {string}
   */
  static get DEFAULT_TOOLBOX_TITLE() {
    return 'Code';
  }

  /**
   * Tool`s prepare method
   * @param config
   */
  static prepare({config = {}}) {
    CodeTool.TOOLBOX_TITLE = config.toolboxTitle || CodeTool.DEFAULT_TOOLBOX_TITLE;
  }
